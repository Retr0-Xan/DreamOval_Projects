...
def main ():
    root = ctk.CTk()
    root.title("KowriReconsApp")
    root.option_add("*tearOff", False)
    root._set_appearance_mode("light")
    root.geometry("500x550")


    def render_recons_frame(root):
        recons_frame = ctk.CTkFrame(root,fg_color="white")
        
        logo_img = ctk.CTkImage(Image.open(resource_path(f"{script_dir}/assets/KowriLogo.png")),size=(200,70))
    ...
    # Import the tcl file
    root.tk.call("source",resource_path(f"{script_dir}/assets/Forest-ttk-theme-master/forest-light.tcl"))
